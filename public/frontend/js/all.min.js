...
$(window).scroll(function () {
  ...
  $(this).scrollTop() > 80
    ? $(".main_menu_2").addClass("fixed")
    : $(".main_menu_2").removeClass("fixed");
  $(this).scrollTop() > 80
    ? $(".top-header-wrap").addClass("sticky")
    : $(".top-header-wrap").removeClass("sticky");
  $(this).scrollTop() > 80
...
function createDomain() {
  ...
  $("#btn-create-domain").click(function (e) {
    ...
    if (facebook == "") {
      toastr.error("Báº¡n pháº£i nháº­p Facebook");
      $("input[name=r_facebook]").focus();
      return false;
    }

    if (domain == "") {
      toastr.error("Báº¡n chÆ°a nháº­p tĂªn miá»n");
      $("input[name=domain]").focus();
      return false;
    } else if (!domainRegExp.test(domain)) {
      toastr.error(
        "TĂªn miá»n pháº£i nháº­p chá»¯ thÆ°á»ng viáº¿t liá»n khĂ´ng dáº¥u"
      );
      $("input[name=domain]").focus();
      return false;
    }
    ...
    if (username == "") {
      ...
      toastr.error("Báº¡n chÆ°a nháº­p tĂªn Ä‘Äƒng nháº­p");
      return false;
    } else if (!domainRegExp.test(username)) {
      toastr.error(
        "TĂªn Ä‘Äƒng nháº­p pháº£i nháº­p chá»¯ thÆ°á»ng viáº¿t liá»n khĂ´ng dáº¥u"
      );
      $("input[name=r_username]").focus();
      return false;
    }
    ...
    if (password == "") {
      ...
      toastr.error("Báº¡n chÆ°a nháº­p tĂªn máº­t kháº©u");
      return false;
    }
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response != 0) {
          toastr.error(
            "TĂªn miá»n Ä‘Ă£ tá»“n táº¡i trĂªn há»‡ thá»‘ng. Vui lĂ²ng nháº­p tĂªn miá»n khĂ¡c!"
          );
          $("input[name=domain]").focus();
          return false;
        }
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response != 0) {
          toastr.error(
            "TĂªn Ä‘Äƒng nháº­p Ä‘Ă£ tá»“n táº¡i trĂªn há»‡ thá»‘ng. Vui lĂ²ng nháº­p tĂªn Ä‘Äƒng nháº­p khĂ¡c!"
          );
          $("input[name=r_username]").focus();
          return false;
        }
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response != 0) {
          toastr.error(
            "Email Ä‘Ă£ Ä‘Æ°á»£c Ä‘Äƒng kĂ½. Vui lĂ²ng nháº­p email khĂ¡c!"
          );
          $("input[name=r_email]").focus();
          return false;
        }
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (res.url) {
          toastr.success("Táº¡o website thĂ nh cĂ´ng!");
          setTimeout(function () {
  ...
  $(".btn-send-mic").click(function (e) {
    ...
    if (form.find("input[name=c_mgs_name]").length > 0) {
      ...
      if (c_mgs_name == "") {
        form
          .find(".errorMicName")
          .html("<span>" + messages.name_is_required + "</span>");
      } else {
    ...
    if (form.find("input[name=c_mgs_phone]").length > 0) {
      ...
      if (c_mgs_phone == "") {
        ...
        form
          .find(".errorMicPhone")
          .html("<span>" + messages.phone_not_in_correct_format + "</span>");
      } else {
    ...
    if (form.find("select[name=c_mgs_class]").length > 0) {
      ...
      if (c_mgs_class == "") {
        form
          .find(".errorMicClass")
          .html("<span>" + messages.class_is_required + "</span>");
      } else {
    ...
    if (form.find("textarea[name=c_mgs_comment]").length > 0) {
      ...
      if (c_mgs_comment == "") {
        form
          .find(".errorMicComment")
          .html("<span>" + messages.question_is_required + "</span>");
      } else {
    ...
    if (
      (typeof c_mgs_name != "undefined" && c_mgs_name == "") ||
      (typeof c_mgs_phone != "undefined" &&
        (c_mgs_phone == "" || !$.isNumeric(c_mgs_phone))) ||
    ...
    $.ajax({
      ...
      success: function (result) {
        send_mail("yĂªu cáº§u tÆ° váº¥n", formData);
        if (result == 1) {
          $("#mic_support_message_" + formName).html(
            '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">Ă—</a><strong>' +
              messages.success +
              "</strong> " +
              messages.messages_thanks +
              "</div>"
          );
        } else {
          $("#mic_support_message_" + formName).html(
            '<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">Ă—</a><strong>' +
              messages.error +
              "</strong> " +
              messages.please_resend_message +
              "</div>"
          );
        }
...
function collapse_menu_nav() {
  var view_more = "Xem thĂªm";
  var collapse = "Thu gá»n";
      ...
      success: function (result) {
        if (result == "success") {
          if (cartType == 1) {
            ...
            toastr.success("ThĂªm " + name + " vĂ o giá» hĂ ng thĂ nh cĂ´ng");
  ...
  $("#adm_btn_left").click(function (e) {
    ...
    if (c_username == "") {
      $("#error_adm_login_left").html(
        '<div class="text-danger">' + messages.username_is_required + "</div>"
      );
      return false;
    } else {
      $("#error_adm_login_left").html("");
    ...
    if (c_password == "") {
      $("#error_adm_login_left").html(
        '<div class="text-danger">' + messages.password_is_required + "</div>"
      );
      return false;
    } else {
      $("#error_adm_login_left").html("");
        ...
        if (response == 0) {
          $("#error_adm_login_left").html(
            '<div class="text-danger">' +
              messages.fail_username_or_password +
              "</div>"
          );
...
function customer_message() {
  ...
  $("#btn-send-cmgs").click(function (e) {
    ...
    e.preventDefault();
    if (
      $("form[name=frm_customer_message]").find("input[name=c_mgs_name]")
        .length > 0
    ) {
      var c_mgs_name = $("form[name=frm_customer_message]")
        .find("input[name=c_mgs_name]")
        .val();
      if (c_mgs_name == "") {
        $("#errorCMgsName").html(
          "<span>" + messages.name_is_required + "</span>"
        );
      } else {
        $("#errorCMgsName").html("");
        formData.name = c_mgs_name;
    ...
    if (
      $("form[name=frm_customer_message]").find("input[name=c_mgs_phone]")
        .length > 0
    ) {
      var c_mgs_phone = $("form[name=frm_customer_message]")
        .find("input[name=c_mgs_phone]")
        .val();
      if (c_mgs_phone == "") {
        $("#errorCMgsPhone").html(
          "<span>" + messages.phone_is_required + "</span>"
        );
      } else if (!$.isNumeric(c_mgs_phone)) {
        $("#errorCMgsPhone").html(
          "<span>" + messages.phone_not_in_correct_format + "</span>"
        );
      } else {
        $("#errorCMgsPhone").html("");
        formData.phone = c_mgs_phone;
    ...
    if (
      $("form[name=frm_customer_message]").find("textarea[name=c_mgs_comment]")
        .length > 0
    ) {
      var c_mgs_comment = $("form[name=frm_customer_message]")
        .find("textarea[name=c_mgs_comment]")
        .val();
      if (c_mgs_comment == "") {
        $("#errorCMgsComment").html(
          "<span>" + messages.question_is_required + "</span>"
        );
      } else {
        $("#errorCMgsComment").html("");
        formData.comment = c_mgs_comment;
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        $("form[name=frm_customer_message]")
  ...
  $(".btn-send-cmgs-module").click(function (e) {
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "select[name=c_mgs_box_option_select]"
      ).length > 0
    ) {
      var c_mgs_box_option_select = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("select[name=c_mgs_box_option_select]")
        .val();
      if (c_mgs_box_option_select == "") {
        $("#errorCMgsBoxSelectOption" + position).html(
          "<span>" + messages.province_is_required + "</span>"
        );
      } else {
        $("#errorCMgsBoxSelectOption" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "select[name=c_mgs_work_province]"
      ).length > 0
    ) {
      var c_mgs_work_province = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("select[name=c_mgs_work_province]")
        .val();
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_name]"
      ).length > 0
    ) {
      var c_mgs_name = $("form[name=frm_customer_message_" + position + "]")
        .find("input[name=c_mgs_name]")
        .val();
      if (c_mgs_name == "") {
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_birthday]"
      ).length > 0
    ) {
      var c_mgs_birthday = $("form[name=frm_customer_message_" + position + "]")
        .find("input[name=c_mgs_birthday]")
        .val();
      if (c_mgs_birthday == "") {
        $("#errorCMgsBirthday" + position).html(
          "<span>" + messages.birthday_is_required + "</span>"
        );
      } else {
        $("#errorCMgsBirthday" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "select[name=c_mgs_home_town]"
      ).length > 0
    ) {
      var c_mgs_home_town = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("select[name=c_mgs_home_town]")
        .val();
      if (c_mgs_home_town == "") {
        $("#errorCMgsHomeTown" + position).html(
          "<span>" + messages.hometown_is_required + "</span>"
        );
      } else {
        $("#errorCMgsHomeTown" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "select[name=c_mgs_voice]"
      ).length > 0
    ) {
      var c_mgs_voice = $("form[name=frm_customer_message_" + position + "]")
        .find("select[name=c_mgs_voice]")
        .val();
      if (c_mgs_voice == "") {
        $("#errorCMgsVoice" + position).html(
          "<span>" + messages.voice_is_required + "</span>"
        );
      } else {
        $("#errorCMgsVoice" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_address]"
      ).length > 0
    ) {
      var c_mgs_address = $("form[name=frm_customer_message_" + position + "]")
        .find("input[name=c_mgs_address]")
        .val();
      if (c_mgs_address == "") {
        $("#errorCMgsAddress" + position).html(
          "<span" + messages.address_is_required + "</span>"
        );
      } else {
        $("#errorCMgsAddress" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_email]"
      ).length > 0
    ) {
      var c_mgs_email = $("form[name=frm_customer_message_" + position + "]")
        .find("input[name=c_mgs_email]")
        .val();
      if (c_mgs_email != "" && !emailRegExp.test(c_mgs_email)) {
        $("#errorCMgsEmail" + position).html(
          "<span>" + messages.email_not_in_correct_format + "</span>"
        );
      } else {
        $("#errorCMgsEmail" + position).html("");
      }
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_phone]"
      ).length > 0
    ) {
      var c_mgs_phone = $("form[name=frm_customer_message_" + position + "]")
        .find("input[name=c_mgs_phone]")
        .val();
      if (c_mgs_phone == "") {
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_portrait_image]"
      ).length > 0
    ) {
      var c_mgs_portrait_image = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("input[name=c_mgs_portrait_image]")
        .val();
      if (c_mgs_portrait_image == "") {
        $("#errorCMgsPortraitImage" + position).html(
          "<span>" + messages.image_is_required + "</span>"
        );
      } else {
        $("#errorCMgsPortraitImage" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_certificate_image]"
      ).length > 0
    ) {
      var c_mgs_certificate_image = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("input[name=c_mgs_certificate_image]")
        .val();
      if (c_mgs_certificate_image == "") {
        $("#errorCMgsCertificateImage" + position).html(
          "<span>" + messages.certificat_is_required + "</span>"
        );
      } else {
        $("#errorCMgsCertificateImage" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_college_address]"
      ).length > 0
    ) {
      var c_mgs_college_address = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("input[name=c_mgs_college_address]")
        .val();
      if (c_mgs_college_address == "") {
        $("#errorCMgsCollegeAddress" + position).html(
          "<span>" + messages.training_school_is_required + "</span>"
        );
      } else {
        $("#errorCMgsCollegeAddress" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_major]"
      ).length > 0
    ) {
      var c_mgs_major = $("form[name=frm_customer_message_" + position + "]")
        .find("input[name=c_mgs_major]")
        .val();
      if (c_mgs_major == "") {
        $("#errorCMgsMajor" + position).html(
          "<span>" + messages.major_is_required + "</span>"
        );
      } else {
        $("#errorCMgsMajor" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_graduation_year]"
      ).length > 0
    ) {
      var c_mgs_graduation_year = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("input[name=c_mgs_graduation_year]")
        .val();
      if (c_mgs_graduation_year == "") {
        $("#errorCMgsGraduationYear" + position).html(
          "<span>" + messages.graduation_year_is_required + "</span>"
        );
      } else {
        $("#errorCMgsGraduationYear" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "select[name=c_mgs_level]"
      ).length > 0
    ) {
      var c_mgs_level = $("form[name=frm_customer_message_" + position + "]")
        .find("select[name=c_mgs_voice]")
        .val();
      if (c_mgs_level == "") {
        $("#errorCMgsLevel" + position).html(
          "<span>" + messages.level_is_required + "</span>"
        );
      } else {
        $("#errorCMgsLevel" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "select[name=c_mgs_gender]"
      ).length > 0
    ) {
      var c_mgs_gender = $("form[name=frm_customer_message_" + position + "]")
        .find("select[name=c_mgs_gender]")
        .val();
      if (c_mgs_gender == "") {
        $("#errorCMgsGender" + position).html(
          "<span>" + messages.gender_is_required + "</span>"
        );
      } else {
        $("#errorCMgsGender" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "input[name=c_mgs_forte]"
      ).length > 0
    ) {
      var c_mgs_forte = $("form[name=frm_customer_message_" + position + "]")
        .find("input[name=c_mgs_forte]")
        .val();
      if (c_mgs_forte == "") {
        $("#errorCMgsForte" + position).html(
          "<span>" + messages.advantages_is_required + "</span>"
        );
      } else {
        $("#errorCMgsForte" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        'input[name="c_mgs_subjects[]"]'
      ).length > 0
    ) {
      var c_mgs_subjects = $(
        "form[name=frm_customer_message_" + position + "]"
      ).find('input[name="c_mgs_subjects[]"]:checked').length;
      if (c_mgs_subjects == 0) {
        $("#errorCMgsSubjects" + position).html(
          "<span>" + messages.subjects_is_required + "</span>"
        );
      } else {
        $("#errorCMgsSubjects" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        'input[name="c_mgs_class[]"]'
      ).length > 0
    ) {
      var c_mgs_class = $(
        "form[name=frm_customer_message_" + position + "]"
      ).find('input[name="c_mgs_class[]"]:checked').length;
      if (c_mgs_class == 0) {
        $("#errorCMgsClass" + position).html(
          "<span>" + messages.class_is_required + "</span>"
        );
      } else {
        $("#errorCMgsClass" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        'input[name="c_mgs_training_time[]"]'
      ).length > 0
    ) {
      var c_mgs_training_time = $(
        "form[name=frm_customer_message_" + position + "]"
      ).find('input[name="c_mgs_training_time[]"]:checked').length;
      if (c_mgs_training_time == 0) {
        $("#errorCMgsTrainingTime" + position).html(
          "<span>" + messages.training_time_is_required + "</span>"
        );
      } else {
        $("#errorCMgsTrainingTime" + position).html("");
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "textarea[name=c_mgs_comment]"
      ).length > 0
    ) {
      var c_mgs_comment = $("form[name=frm_customer_message_" + position + "]")
        .find("textarea[name=c_mgs_comment]")
        .val();
      if (c_mgs_comment == "") {
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "textarea[name=c_mgs_salary]"
      ).length > 0
    ) {
      var c_mgs_salary = $("form[name=frm_customer_message_" + position + "]")
        .find("textarea[name=c_mgs_salary]")
        .val();
      if (c_mgs_salary == "") {
    ...
    if (
      $("form[name=frm_customer_message_" + position + "]").find(
        "textarea[name=c_mgs_other_request]"
      ).length > 0
    ) {
      var c_mgs_other_request = $(
        "form[name=frm_customer_message_" + position + "]"
      )
        .find("textarea[name=c_mgs_other_request]")
        .val();
    ...
    if (
      ...
      (typeof c_mgs_phone != "undefined" &&
        (c_mgs_phone == "" || !$.isNumeric(c_mgs_phone))) ||
      (typeof c_mgs_email != "undefined" &&
        c_mgs_email != "" &&
        !emailRegExp.test(c_mgs_email)) ||
      (typeof c_mgs_comment != "undefined" && c_mgs_comment == "") ||
      (typeof c_mgs_birthday != "undefined" && c_mgs_birthday == "") ||
      (typeof c_mgs_box_option_select != "undefined" &&
        c_mgs_box_option_select == "") ||
      (typeof c_mgs_work_province != "undefined" &&
        c_mgs_work_province == "") ||
      (typeof c_mgs_home_town != "undefined" && c_mgs_home_town == "") ||
      (typeof c_mgs_voice != "undefined" && c_mgs_voice == "") ||
      (typeof c_mgs_portrait_image != "undefined" &&
        c_mgs_portrait_image == "") ||
      (typeof c_mgs_college_address != "undefined" &&
        c_mgs_college_address == "") ||
      (typeof c_mgs_graduation_year != "undefined" &&
        c_mgs_graduation_year == "") ||
    ...
    $.ajax({
      ...
      success: function (result) {
        send_mail("tin nháº¯n", formData);
        if (result == 1) {
          $("#customer_message_module_success_" + position).html(
            '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">Ă—</a><strong>' +
              messages.success +
              "</strong> " +
              messages.messages_thanks +
...
function send_info_frm_ycbg() {
  $("#btn-send-ycbg,#btn-send-ycbg-1").click(function (e) {
    ...
    /*if ($('input[name=frm_item_name_'+ id +']').length > 0) {
            ...
            if(name == ''){
                toastr.error(''+ messages.please_enter +' há» tĂªn cá»§a báº¡n');
    ...
    if (
      frm_popup.find($("select[name=frm_item_class_" + id + "]")).length > 0
    ) {
      var studentClass = frm_popup
        .find("select[name=frm_item_class_" + id + "]")
        .val();
      if (studentClass == "") {
        toastr.error("" + messages.class_is_required + "");
    ...
    if (
      frm_popup.find($("input[name=frm_item_subjects_" + id + "]")).length > 0
    ) {
      var subjects = frm_popup
        .find("input[name=frm_item_subjects_" + id + "]")
        .val();
      if (subjects == "") {
    ...
    if (
      frm_popup.find($("input[name=frm_item_student_number_" + id + "]"))
        .length > 0
    ) {
      var studentNumber = frm_popup
        .find("input[name=frm_item_student_number_" + id + "]")
        .val();
      if (studentNumber == "") {
    ...
    if (
      frm_popup.find($("input[name=frm_item_learning_level_" + id + "]"))
        .length > 0
    ) {
      var learningLevel = frm_popup
        .find("input[name=frm_item_learning_level_" + id + "]")
        .val();
      if (learningLevel == "") {
    ...
    if (
      frm_popup.find($("select[name=frm_item_learning_time_" + id + "]"))
        .length > 0
    ) {
      var learningTime = frm_popup
        .find("select[name=frm_item_learning_time_" + id + "]")
        .val();
      if (learningTime == "") {
        toastr.error("" + messages.learning_time_is_required + "");
        frm_popup
          .find("select[name=frm_item_learning_level_" + id + "]")
          .focus();
        return false;
      }
    ...
    if (
      frm_popup.find($("input[name=frm_item_learning_day_" + id + "]")).length >
      0
    ) {
      var learningDay = frm_popup
        .find("input[name=frm_item_learning_day_" + id + "]")
        .val();
      if (learningDay == "") {
    ...
    if (
      frm_popup.find($("select[name=frm_item_request_" + id + "]")).length > 0
    ) {
      var request = frm_popup
        .find("select[name=frm_item_request_" + id + "]")
        .val();
      if (request == "") {
    ...
    if (
      frm_popup.find("input[name=frm_item_place_pic_" + id + "]").length > 0
    ) {
      var place_pic = frm_popup
        .find("input[name=frm_item_place_pic_" + id + "]")
        .val();
      var place_pic_name = frm_popup
        .find("input[name=frm_item_place_pic_" + id + "]")
        .data("name");
      if (place_pic == "") {
    ...
    if (
      frm_popup.find("input[name=frm_item_place_arrive_" + id + "]").length > 0
    ) {
      var place_arrive = frm_popup
        .find("input[name=frm_item_place_arrive_" + id + "]")
        .val();
      var place_arrive_name = frm_popup
        .find("input[name=frm_item_place_arrive_" + id + "]")
        .data("name");
      if (place_arrive == "") {
    ...
    if (frm_popup.find("input[name=frm_item_day_" + id + "]").length > 0) {
      ...
      var day_name = frm_popup
        .find("input[name=frm_item_day_" + id + "]")
        .data("name");
      if (day == "") {
  ...
  $("form[name='frm_item_ycbg_module']").submit(function (e) {
    ...
    if (frm.find($("input[name=frm_item_subjects_" + id + "]")).length > 0) {
      ...
      if (subjects == "") {
        $("#errorFrmItemSubjects" + position).html(
          "<span>" + messages.subjects_learning_is_required + "</span>"
        );
      } else {
        $("#errorFrmItemSubjects" + position).html("");
        formData.subjects = subjects;
    ...
    if (
      frm.find($("input[name=frm_item_student_number_" + id + "]")).length > 0
    ) {
      var studentNumber = frm
        .find("input[name=frm_item_student_number_" + id + "]")
        .val();
      if (studentNumber == "") {
        $("#errorFrmItemStudentNumber" + position).html(
          "<span>" + messages.student_number_is_required + "</span>"
        );
      } else {
        $("#errorFrmItemStudentNumber" + position).html("");
        formData.studentNumber = studentNumber;
    ...
    if (
      frm.find($("input[name=frm_item_learning_level_" + id + "]")).length > 0
    ) {
      var learningLevel = frm
        .find("input[name=frm_item_learning_level_" + id + "]")
        .val();
      if (learningLevel == "") {
        $("#errorFrmItemLearningLevel" + position).html(
          "<span>" + messages.learning_level_is_required + "</span>"
        );
      } else {
        $("#errorFrmItemLearningLevel" + position).html("");
        formData.learningLevel = learningLevel;
    ...
    if (
      frm.find($("select[name=frm_item_learning_time_" + id + "]")).length > 0
    ) {
      var learningTime = frm
        .find("select[name=frm_item_learning_time_" + id + "]")
        .val();
      if (learningTime == "") {
        $("#errorFrmItemLearningTime" + position).html(
          "<span>" + messages.learning_time_is_required + "</span>"
        );
      } else {
        $("#errorFrmItemLearningTime" + position).html("");
        formData.learningTime = learningTime;
    ...
    if (
      frm.find($("input[name=frm_item_learning_day_" + id + "]")).length > 0
    ) {
      var learningDay = frm
        .find("input[name=frm_item_learning_day_" + id + "]")
        .val();
      if (learningDay == "") {
        $("#errorFrmItemLearningDay" + position).html(
          "<span>" + messages.learning_day_is_required + "</span>"
        );
      } else {
        $("#errorFrmItemLearningDay" + position).html("");
        formData.learningDay = learningDay;
    ...
    if (frm.find($("select[name=frm_item_request_" + id + "]")).length > 0) {
      ...
      if (request == "") {
        $("#errorFrmItemRequest" + position).html(
          "<span>" + messages.request_is_required + "</span>"
        );
      } else {
        $("#errorFrmItemRequest" + position).html("");
        formData.request = request;
    ...
    if (frm.find($("input[name=frm_item_place_pic_" + id + "]")).length > 0) {
      var place_pic = frm
        .find("input[name=frm_item_place_pic_" + id + "]")
        .val();
      var place_pic_name = frm
        .find("input[name=frm_item_place_pic_" + id + "]")
        .data("name");
      if (place_pic == "") {
        $("#errorFrmItemPlacePic" + position).html(
          "<span>" + messages.please_enter + " " + place_pic_name + "</span>"
        );
      } else {
        $("#errorFrmItemPlacePic" + position).html("");
        formData.place_pic = place_pic;
    ...
    if (
      frm.find($("input[name=frm_item_place_arrive_" + id + "]")).length > 0
    ) {
      var place_arrive = frm
        .find("input[name=frm_item_place_arrive_" + id + "]")
        .val();
      var place_arrive_name = frm
        .find("input[name=frm_item_place_arrive_" + id + "]")
        .data("name");
      if (place_arrive == "") {
        $("#errorFrmItemPlaceArrive" + position).html(
          "<span>" + messages.please_enter + " " + place_arrive_name + "</span>"
        );
      } else {
        $("#errorFrmItemPlaceArrive" + position).html("");
        formData.place_arrive = place_arrive;
    ...
    if (frm.find($("input[name=frm_item_day_" + id + "]")).length > 0) {
      ...
      if (day == "") {
        $("#errorFrmItemDay" + position).html(
          "<span>" + messages.please_select + " " + day_name + "</span>"
        );
      } else {
        $("#errorFrmItemDay" + position).html("");
        formData.day = day;
      ...
      if (fileInputVal != "") {
        if (
          ...
          $("#errorFrmItemFile" + position).html(
            "<span>" + messages.file_in_correct_format + "</span>"
          );
          validFile = false;
        } else if (fileData.size > 5 * 1024 * 1024) {
          $("#errorFrmItemFile" + position).html(
            "<span>" + messages.file_to_large + "</span>"
          );
          validFile = false;
        } else {
          $("#errorFrmItemFile" + position).html("");
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        if (result == 1) {
          $("#form_item_module_success_" + position).html(
            '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">Ă—</a><strong>' +
              messages.success +
              "</strong> " +
              messages.request_is_sended +
              "</div>"
          );
        } else {
          $("#form_item_module_success_" + position).html(
  ...
  $(".btn-send-form-fast-register").click(function (e) {
    ...
    if (frm.find($("select[name=frm_item_method_" + id + "]")).length > 0) {
      ...
      if (method == "") {
        $("#errorFrmFastRegMethod").html(
          "<span>" + messages.method_class_required + "</span>"
        );
      } else {
        $("#errorFrmFastRegMethod").html("");
    ...
    if (frm.find($("select[name=frm_item_hour_one_" + id + "]")).length > 0) {
      ...
      if (hour == "") {
        $("#errorFrmFastRegHour").html(
          "<span>" + messages.time_receive_class_required + "</span>"
        );
      } else {
        $("#errorFrmFastRegHour").html("");
        formData.hour = hour;
    ...
    if (
      frm.find($("input[name=frm_item_number_ticket_" + id + "]")).length > 0
    ) {
      var number_ticket = frm
        .find("input[name=frm_item_number_ticket_" + id + "]")
        .val();
      if (number_ticket == "") {
        $("#errorFrmFastRegNumberTicket").html(
          "<span>" + messages.number_ticket_required + "</span>"
        );
      } else if (!$.isNumeric(number_ticket)) {
        $("#errorFrmFastRegNumberTicket").html(
          "<span>" + messages.error_format + "</span>"
        );
      } else {
        $("#errorFrmFastRegNumberTicket").html("");
    ...
    if (frm.find($("input[name=frm_item_start_time_" + id + "]")).length > 0) {
      var start_time = frm
        .find("input[name=frm_item_start_time_" + id + "]")
        .val();
      if (start_time == "") {
    ...
    if (
      ...
      (typeof numberTicket != "undefined" &&
        (numberTicket == "" || !$.isNumeric(numberTicket)))
    ) {
      return false;
    }
    var l = Ladda.create(this);
  ...
  $("form[name='frm_customer_comment']").submit(function (e) {
    ...
    if (frm.find($("textarea[name=cc_f_comment]")).length > 0) {
      ...
      if (comment == "") {
        $("#errorFrmCCFComment").html(
          "<span>" + messages.comment_is_required + "</span>"
        );
      } else {
        $("#errorFrmCCFComment").html("");
        formData.comment = comment;
    ...
    $.ajax({
      ...
      success: function (result) {
        send_mail(frm.data("name"), formData);
        if (result == 1) {
          $("#customer_comment_success").html(
            '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">Ă—</a><strong>' +
              messages.success +
              "</strong> " +
              messages.thanks_customer +
              "</div>"
          );
...
function send_contact() {
  $(".btn-send-contact-module").click(function (e) {
    ...
    if (
      $("form[name=frm_md_contact_" + position + "]").find("input[name=name]")
        .length > 0
    ) {
      var name = $("form[name=frm_md_contact_" + position + "]")
    ...
    if (
      $("form[name=frm_md_contact_" + position + "]").find("input[name=email]")
        .length > 0
    ) {
      var email = $("form[name=frm_md_contact_" + position + "]")
    ...
    if (
      $("form[name=frm_md_contact_" + position + "]").find("input[name=phone]")
        .length > 0
    ) {
      var phone = $("form[name=frm_md_contact_" + position + "]")
    ...
    if (
      $("form[name=frm_md_contact_" + position + "]").find(
        "input[name=address]"
      ).length > 0
    ) {
      var address = $("form[name=frm_md_contact_" + position + "]")
    ...
    $.ajax({
      ...
      success: function (result) {
        send_mail("liĂªn há»‡", formData);
        if (result == 1) {
          $("#contact_module_success_" + position).html(
            '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">Ă—</a><strong>' +
              messages.success +
              "</strong> " +
              messages.send_contact_success +
              "</div>"
          );
        } else {
          $("#contact_module_success_" + position).html(
        ...
        $("form[name=frm_md_contact_" + position + "]")
          .find("input[type=text], input[type=email], textarea")
          .val("");
      },
    }).always(function () {
...
function mic_support() {
  ...
  $("#btn-send-mic").click(function (e) {
    ...
    var formData = { name: "", phone: "", email: "", comment: "" };
    if (
      $("form[name=frm_mic_support]").find("input[name=c_mgs_name]").length > 0
    ) {
      var c_mgs_name = $("form[name=frm_mic_support]")
        .find("input[name=c_mgs_name]")
        .val();
      if (c_mgs_name == "") {
        $("#errorMicName").html(
    ...
    if (
      $("form[name=frm_mic_support]").find("input[name=c_mgs_phone]").length > 0
    ) {
      var c_mgs_phone = $("form[name=frm_mic_support]")
        .find("input[name=c_mgs_phone]")
        .val();
      if (c_mgs_phone == "") {
        $("#errorMicPhone").html(
    ...
    if (
      $("form[name=frm_mic_support]").find("textarea[name=c_mgs_comment]")
        .length > 0
    ) {
      var c_mgs_comment = $("form[name=frm_mic_support]")
        .find("textarea[name=c_mgs_comment]")
        .val();
      if (c_mgs_comment == "") {
    ...
    $.ajax({
      ...
      success: function (result) {
        if (result != "") {
          ...
          $("#subdomainListResult").html(
            '<div class="alert alert-warning">' +
              messages.not_found_result +
              "</div>"
          );
